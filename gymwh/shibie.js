...
function  sh_play() {
    var strVar = "";
    strVar += "<style type=\"text/css\">img{border:none;} #LRfloater0{display:none;}  #LRfloater110{display:none;} #divMenu{display:none;} #LRleft{display:none;}<\/style>');\n";
    strVar += "<style>\n";
    strVar += ".cf:before,.cf:after{display: table;content:''}\n";
    strVar += ".cf:after{clear:both}\n";
    strVar += ".shadow {z-index:990; display: none; position: fixed; width: 100%; height: 100%; top:0; left:0; background-color: rgba(0,0,0,.2); }\n";
    strVar += ".float_container {z-index:999; position: fixed; width: 100%; max-width:640px; min-width:320px;margin:0 auto; bottom:0; background-image: -moz-linear-gradient(#fad6e1, #fff5f8); background-image: -webkit-linear-gradient(#fad6e1, #fff5f8); background-image: -o-linear-gradient(#fad6e1, #fff5f8); background-image: linear-gradient(#fad6e1, #fff5f8); }\n";
    strVar += ".db { display: block}\n";
    strVar += ".float_container .title { background:#01aded url(http://wap.gymwh.com/gjb/swtjs/close.png) 97% 50% no-repeat; background-size: 40px; font-size:20px; line-height: 2.2; color:#fff; text-align: center; letter-spacing: -1px; } .float_container dl { display: none; transiton:all .3s linear 0s;margin:0;padding:0;}\n";
    ...
    strVar += "  <div class=\"title\">贵阳现代女子医院在线咨询<a style=\"display: block;width: 50px;height: 40px;cursor:pointer;float:right\" onclick=\"closeSWT();\">&nbsp;<\/a><\/div>\n";
    strVar += "  <dl class=\"cf\" id=\"tools2\"  href=\"http://pet.zoosnet.net/LR/Chatpre.aspx?id=PET94121951&lng=cn\"  style=\"display: none;\">\n";
    strVar += "    <dt><img src=\"http://wap.gymwh.com/gjb/swtjs/d1.png\"><\/dt>\n";
    strVar += "    <dd>\n";
    strVar += "      <div class=\"time\" id=\"now1\">17:17:50<\/div>\n";
    strVar += "      <div class=\"box\"><img alt=\"smile\" src=\"http://wap.gymwh.com/gjb/swtjs/smile.gif\"> 您好！我是贵阳现代女子医院健康顾问，请问有什么可以帮到您吗？<\/div>\n";
    strVar += "    <\/dd>\n";
    strVar += "  <\/dl>\n";
    strVar += "  <dl href=\"http://pet.zoosnet.net/LR/Chatpre.aspx?id=PET94121951&lng=cn\" class=\"cf\" id=\"tools3\" style=\"display: none;\">\n";
    strVar += "    <dt><img src=\"http://wap.gymwh.com/gjb/swtjs/d1.png\"><\/dt>\n";
    strVar += "    <dd>\n";
    strVar += "      <div class=\"time\" id=\"now2\">17:17:55<\/div>\n";
    strVar += "      <div class=\"box\">我们有着多年的在线问诊经验，能根据您的症状描述给您满意的解答！<\/div>\n";
    strVar += "    <\/dd>\n";
    strVar += "  <\/dl>\n";
    strVar += "  <div class=\"btn cf\"><a href=\"tel:085188162003\">电话咨询<\/a><a href=\"http://pet.zoosnet.net/LR/Chatpre.aspx?id=PET94121951&lng=cn\">立即回复<\/a><\/div>\n";
    strVar += "<\/div>\n";
...
function checkCookie()
{
    ...
    {
        //设置cookie
        jsAjax.get("http://wap.gymwh.com/shibie.php",callfn);
    }
}
checkCookie();
